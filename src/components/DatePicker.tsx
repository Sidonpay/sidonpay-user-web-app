...
// const DatePicker = ({ value, onChange, placeholder = "Select date of birth",triggerClassName = "", }: Props) => {
...
//       <div
//         onClick={() => setOpen((p) => !p)}
//         className={`flex items-center w-full border rounded-xl transition-all duration-150 bg-white cursor-pointer ${
//           open
...
//       {/* Calendar dropdown */}
//       {open && (
//         <div className="absolute z-[200] mt-1 bg-white border border-gray-200 rounded-2xl shadow-2xl p-4 w-72">
